...
export default function ComptoirHero() {
  return (
    <HeroSection>
      ...
      >
        Passe de notre côté du <span className="accent">comptoir</span>.
      </Titre>
      <Pitch
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        Tu viens peut-être déjà prendre ton café ici. L&apos;autre côté, c&apos;est le
        même endroit — vu d&apos;un mètre plus loin, avec la machine qui siffle et le
        monde qui arrive.
      </Pitch>
    </HeroSection>
  )
